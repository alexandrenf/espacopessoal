...
const providerColors: Record<string, string> = {
  google: "hover:bg-gray-50 border-gray-300 text-gray-700 hover:border-gray-400",
  discord: "hover:bg-indigo-50 border-indigo-200 text-indigo-700 hover:border-indigo-300",
  email: "hover:bg-blue-50 border-blue-200 text-blue-700 hover:border-blue-300",
};

export function SignInProviderButton({ provider, isLoading, onClick }: SignInProviderButtonProps) {
  return (
    <Button
      variant="outline"
