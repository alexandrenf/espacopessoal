      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="rounded-lg bg-white p-8 shadow-sm">
          <section className="mb-8">
            ...
            <p className="mb-4">
              Bem-vindo à Política de Privacidade do Espaço Pessoal. Esta
              política descreve como coletamos, usamos, processamos e
              compartilhamos suas informações quando você utiliza nosso serviço.
            </p>
            <p>
              Ao utilizar o Espaço Pessoal, você concorda com a coleta e uso de
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              <strong>Informações de Conta:</strong> Quando você se registra,
              coletamos seu nome, endereço de e-mail e outras informações
              necessárias para criar e gerenciar sua conta.
            </p>
            <p className="mb-4">
              <strong>Conteúdo do Usuário:</strong> Coletamos e armazenamos as
              notas e outros conteúdos que você cria, carrega ou armazena em
              nosso serviço.
            </p>
            <p className="mb-4">
              <strong>Informações de Uso:</strong> Coletamos informações sobre
              como você interage com nosso serviço, incluindo acessos, cliques,
              e outras ações realizadas no aplicativo.
            </p>
            <p>
              <strong>Informações do Dispositivo:</strong> Podemos coletar
              informações sobre o dispositivo que você usa para acessar nosso
              serviço, incluindo modelo de hardware, sistema operacional, e
          ...
          <section className="mb-8">
            ...
            <ul className="mb-4 list-disc space-y-2 pl-6">
              ...
              <li>
                Enviar informações técnicas, atualizações e mensagens de suporte
              </li>
              <li>
                Monitorar o uso do serviço para desenvolvimento de novos
                recursos
              </li>
              <li>
          ...
          <section className="mb-8">
            <h2 className="mb-4 text-xl font-semibold">6. Seus Direitos</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="mb-4 text-xl font-semibold">8. Contato</h2>
            <p>
              Se você tiver dúvidas sobre esta Política de Privacidade, entre em
              contato conosco pelo e-mail: contato@espacopessoal.com
            </p>
          </section>
        </div>
      </div>
